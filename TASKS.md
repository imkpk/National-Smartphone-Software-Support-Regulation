...
> **Phase 3 Complete (v0.5.0).** WS1–WS6 + audit + formal close. Phase 4+ requires new authorization.
...
3. Next (when authorised): **Phase 4** (Government Policy & Institutions) — **not auto-started**.  
