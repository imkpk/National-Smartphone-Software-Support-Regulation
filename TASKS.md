...
> **Phase 4 Complete (v0.6.0).** Phase 5 **in progress** (WS1 complete v0.6.1; WS2 Android ecosystem → v0.6.2). See `PHASE_05_SPECIFICATION.md` · `REPOSITORY_OS.md`.
...
| 5 | [`tasks/phase-05.md`](tasks/phase-05.md) | **In progress** (WS1+WS2 complete) | 55 | 13 | 68 |
...
4. **Phase 5 WS1+WS2** — manufacturers + Android ecosystem (v0.6.1 / v0.6.2). Further Phase 5 WS — **not auto-started**.  
