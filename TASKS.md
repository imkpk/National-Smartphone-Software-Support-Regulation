...
> **Phase 3 WS1–WS5 complete** (SC, HC, regulators, committees, comparative). Phase 3 formal close still open. Phase 4+ not started.
...
| 3 | [`tasks/phase-03.md`](tasks/phase-03.md) | **In progress** (WS1–WS5 done; formal close open) | 34 | 0 | 34 |
...
2. **Phase 3 WS1–WS5 done** — SC, HC, regulators, committees, comparative (`research/judgments/`, `research/regulators/`, `research/committees/`, `research/international/`).  
3. Next (when authorised): **WS6 Gap Analysis** → Phase 3 audit → formal close — **not auto-started**.  
