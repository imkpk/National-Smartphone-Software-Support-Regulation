...
> **Phase 3 WS1–WS6 complete** (SC, HC, regulators, committees, comparative, gap analysis). Phase 3 formal audit/close still open. Phase 4+ not started.
...
| 3 | [`tasks/phase-03.md`](tasks/phase-03.md) | **In progress** (WS1–WS6 done; formal audit/close open) | 34 | 0 | 34 |
...
2. **Phase 3 WS1–WS6 done** — including gap analysis (`research/gap-analysis/`).  
3. Next (when authorised): **Phase 3 Audit** → formal close — **not auto-started**.  
