...
> **Phase 3 Complete.** Phase 4 **in progress** (WS1–WS5 when 0.5.6 merges). Next after merge: **WS6 Gap Analysis** (authorisation required). See `REPOSITORY_OS.md` + `PHASE_04_SPECIFICATION.md`.
...
| 4 | [`tasks/phase-04.md`](tasks/phase-04.md) | **In progress** (WS1–WS5) | 16 | 8 | 24 |
...
3. **Phase 4 WS1–WS5** — through government programmes. Next (when authorised): **WS6 Gap Analysis** — **not auto-started**.  
