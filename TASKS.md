...
> **Phase 3 Complete.** Phase 4 **in progress** (WS1–WS4 when 0.5.5 merges). Next after merge: **WS5 Programmes** (authorisation required). See `REPOSITORY_OS.md` + `PHASE_04_SPECIFICATION.md`.
...
| 4 | [`tasks/phase-04.md`](tasks/phase-04.md) | **In progress** (WS1–WS4) | 15 | 9 | 24 |
...
3. **Phase 4 WS1–WS4** — through public consultations. Next (when authorised): **WS5 Programmes** — **not auto-started**.  
