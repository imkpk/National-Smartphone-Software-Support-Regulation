...
> **Phase 4 Complete (v0.6.0).** Phase 5 **in progress** (WS1–WS4 complete; WS5 gap → v0.6.5). See `PHASE_05_SPECIFICATION.md` · `REPOSITORY_OS.md`.
...
| 5 | [`tasks/phase-05.md`](tasks/phase-05.md) | **In progress** (WS1–WS5 complete) | 57 | 11 | 68 |
...
4. **Phase 5 WS1–WS5** — manufacturers + Android + hardware + comparative + gap analysis (v0.6.1–0.6.5). Further Phase 5 WS — **not auto-started**.  
